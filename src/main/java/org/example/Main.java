...
//        delivererRepository.addDeliver(delivererController.setDeliverer());
//
//
//        Payment payment1 = new Payment(2022, 5, 12, 1, 30.00d);
...
//        outputFile.writeJsonFile(delivererRepository, paymentRepository, "dane.json");
        ...
        if (delivererRepository.deliverers.size() > 0) {
            System.out.println(delivererRepository.toString());
        } else {
